package in.ankit.eligdet.restcontrollers;
...
public class EdController {
	...
	public ResponseEntity<String> generateCO(@PathVariable Long caseNum){
		boolean status = edService.generateCo(caseNum);
		if(status) {
